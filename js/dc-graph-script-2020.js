      var numberFormat = d3.format(".2f");
        ...
        function isWolvesRecord(v) {
            return v.packLevel === "Yearling" || v.sex === "Undetermined";
        }

        d3.csv("data/YellowstoneWolves2020.csv").then(function(csv) {
            ...
            mapChart.dimension(packDimension)
                    ...
                    .point("Phantom Lake", 230, 70)
                    .point("Junction Butte", 320, 70)
                    .point("Bechler", 80, 400)
                    .point("Lone Wolves", 100, 100)
